...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f5e6de]  flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto flex justify-center py-8 px-4">
        <div className="flex flex-col md:flex-row w-full max-w-2xl shadow-xl rounded-md overflow-hidden bg-white">
          ...
          {/* Left Image Section */}
          <div
            className="hidden md:block md:w-1/2 md:order-1 bg-cover bg-center"
           style={{
  backgroundImage: `url("/elegant.png")`,
  ...
  minHeight: "500px",
          ...
          {/* Right Form Section */}
          <div className="w-full md:w-1/2 flex flex-col justify-center px-6 py-6 md:py-8 md:order-2">
            <h2 className="text-2xl md:text-4xl  font-extrabold mb-6 text-[#5c3a21] text-left">
              Create Account
            </h2>
